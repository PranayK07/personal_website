            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                <div
                  ...
                  className="flex flex-col items-center p-6 bg-section-bg/50 backdrop-blur-sm rounded-xl border border-card-border hover:border-accent transition-all duration-300 hover:shadow-[0_0_20px_rgba(20,184,166,0.2)] group"
                >
              ...
              <div className="pt-6 border-t border-card-border/50">
                ...
                <div className="flex flex-wrap justify-center gap-3">
                  <a
                    ...
                    className="flex items-center gap-2 px-5 py-3 bg-section-bg/50 backdrop-blur-sm rounded-xl border border-card-border hover:border-accent hover:bg-accent/10 transition-all duration-300 hover:scale-105 hover:shadow-[0_0_15px_rgba(20,184,166,0.2)] group"
                  >

            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                <div
                  ...
                  className="flex flex-col items-center p-6 bg-section-bg/50 backdrop-blur-sm rounded-xl transition-all duration-300 hover:shadow-[0_0_20px_rgba(20,184,166,0.2)] group"
                >
